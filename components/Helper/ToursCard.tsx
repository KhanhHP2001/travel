...
const ToursCard = ({ image, name, city, reviewNum, price }: Props) => {
    return (
        <Link href={`/tour/${encodeURIComponent(name)}`}>
            <div className='cursor-pointer bg-white rounded-md overflow-hidden'>
                ...
                <div className='p-[1.4rem]'>
                    ...
                    <div className='w-[100%] opacity-60 h-[-0.7px] mt-[1rem] bg-gray-800 '></div>
                    ...
                    <h1 className='text-[15px] mt-[1rem] flex items-center space-x-3'>
                        <span className='text-[15px] text-black opacity-70'>Từ:</span>
                        <span className='text-[16px] text-orange-600 font-bold'>
                            {price}<span className='text-[15px] text-black opacity-70'>/Khách</span>
                        </span>
                    </h1>
                </div>
            </div>
